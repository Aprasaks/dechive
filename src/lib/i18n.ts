...
const i18n = {
  ko: {
    ...
    aboutArchiveDescription: '하나의 질문으로 남긴 기록입니다.\n각 글은 이어지는 시리즈가 아니라,\n다시 꺼내볼 수 있는 독립된 이해의 조각입니다.',
    aboutDeepDiveTitle: 'Deep Dive',
    aboutDeepDiveDescription: '하나의 키워드를 끝까지 파고드는 심층 문서입니다.\n개념, 예시, 실수, 한계, 추론, 검증 기준까지 정리합니다.',
  ...
  en: {
    ...
    aboutArchiveTitle: 'Archive',
    aboutArchiveDescription: 'Short records left from a single question.\nEach post is not part of a series,\nbut an independent fragment of understanding.',
    aboutDeepDiveTitle: 'Deep Dive',
    aboutDeepDiveDescription: 'A deeper document that follows one keyword to the end.\nIt organizes concepts, examples, mistakes, limits, reasoning, and verification criteria.',
