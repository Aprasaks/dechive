...
function PolicyLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <a
      ...
      className="text-[#6f4f22] underline underline-offset-4 transition-colors hover:text-[#17120d]"
    >
      {children}
    </a>
  );
...
export default function PrivacyPolicyClient() {
  ...
  if (lang === 'en') {
    return (
      <main className="min-h-[calc(100vh-5rem)] bg-[#f8f6f1] px-6 py-12 text-[#19140f]">
        <article className="mx-auto max-w-3xl">
        <h1 className="mb-8 text-3xl font-extrabold tracking-tight text-[#17120d]">
          Privacy Policy
        </h1>

        <div className="flex flex-col gap-8 text-[#4b4036]">
          <section>
            <p className="text-sm text-[#8b8175]">Last updated: May 6, 2026</p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold text-[#17120d]">Information We Collect</h2>
            ...
            <ul className="mt-3 flex flex-col gap-2 pl-5 text-sm leading-relaxed text-[#5f564d]">
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold text-[#17120d]">Google AdSense & Advertising</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold text-[#17120d]">Cookies</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold text-[#17120d]">Google Analytics</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold text-[#17120d]">Third-Party Links</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold text-[#17120d]">Children&apos;s Privacy</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold text-[#17120d]">Changes to This Policy</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold text-[#17120d]">Contact</h2>
            <p className="leading-relaxed">
              If you have any questions about this Privacy Policy, please contact{' '}
              <a href="mailto:heavenis0113@gmail.com" className="text-[#6f4f22] underline underline-offset-4 transition-colors hover:text-[#17120d]">
  ...
  return (
    <main className="min-h-[calc(100vh-5rem)] bg-[#f8f6f1] px-6 py-12 text-[#19140f]">
      ...
      <div className="flex flex-col gap-8 text-[#4b4036]">
        <section>
          <p className="text-sm text-[#8b8175]">최종 수정일: 2026년 5월 6일</p>
          <p className="mt-4 leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-[#17120d]">수집하는 정보</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-[#17120d]">Google AdSense 및 광고</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-[#17120d]">쿠키</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-[#17120d]">제3자 링크</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-[#17120d]">아동의 개인정보</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-[#17120d]">방침의 변경</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-[#17120d]">문의</h2>
          <p className="leading-relaxed">
            이 개인정보처리방침에 관한 질문은{' '}
            <a href="mailto:heavenis0113@gmail.com" className="text-[#6f4f22] underline underline-offset-4 transition-colors hover:text-[#17120d]">
              heavenis0113@gmail.com
