...
공개 구조를 Knowledge, Lecture, Practice, AI Update, Books로 재설정했다. legacy Archive/Deep Dive/기존 AI Updates/Book/Library 및 영어 legacy URL은 이전·redirect하지 않고 410으로 정리한다. AI Update는 official dates와 immutable official sources를 가진 published-only CMS로 구현한다.
