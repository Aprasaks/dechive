...
메인은 따뜻한 종이색·먹색·짙은 녹색의 차분한 편집형 디자인을 사용한다. 본문과 인터페이스는 Pretendard Variable을 중심으로 구성하고, DECHIVE 워드마크에만 절제된 세리프를 사용한다. Knowledge를 중심에 두고 Lecture와 Practice를 첫 화면에 함께 배치한다. 큰 소개 문구만 놓지 않고 실제 발행 콘텐츠와 다섯 영역의 탐색 구조를 첫 화면에서 바로 보여준다.
